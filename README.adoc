...
[WARNING]
====
**Spring Data Solr has been discontinued and is currently only maintained in its current version for support reasons until early 2023 at which point it is going to be moved to the https://github.com/spring-attic/[Spring Attic] entirely. The team has laid out the reasons to discontinue the project https://spring.io/blog/2020/04/07/spring-data-for-apache-solr-discontinued[here]. For current users of Spring Data Solr, we recommend to look into alternative search-engine-related modules like https://github.com/spring-projects/spring-data-elasticsearch[Spring Data Elasticsearch].**
====
